...
|--------|-----------|----------------|
| **Issue Validator** | Valida issues abertas no path Manutenção contra o [checklist de 7 itens](../guias/checklist-abertura-issue.md). Adiciona comentário interno e tag `abertura-incompleta` nas issues incompletas. | `valida as issues` |
